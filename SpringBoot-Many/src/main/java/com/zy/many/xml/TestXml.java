...
public class TestXml {
	...
	public static void main(String[] args) throws JDOMException, IOException {
		 ...
		 * System.out.println("****************"); for (GameProtocolXMLEntity
		 * game: list) {
		 * System.out.println(game.getTitle_head()+game.getTitle_body()+game.
		 * toListbody_head(game.getListbody_head())+
		 * game.tobodylist(game.getListbody())+game.tobody1list(game.
		 * getListbody1())+game.tobody2list(game.getListbody2())); }
		 */
